...
class ToggleFileRecentChangesCommand extends common_1.EditorCommand {
    ...
    execute(editor, edit, uri) {
        return __awaiter(this, void 0, void 0, function* () {
            if (editor === undefined || editor.document.isDirty)
                return undefined;
            if (uri !== undefined && !comparers_1.UriComparer.equals(uri, editor.document.uri)) {
                const e = vscode_1.window.visibleTextEditors.find(e => comparers_1.UriComparer.equals(uri, e.document.uri));
