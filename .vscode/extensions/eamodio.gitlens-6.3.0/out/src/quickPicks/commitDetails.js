...
class OpenCommitFilesCommandQuickPickItem extends common_1.OpenFilesCommandQuickPickItem {
    constructor(commit, versioned = false, item) {
        ...
        const uris = system_1.Arrays.filterMap(commit.fileStatuses, f => f.status !== 'D' ? gitService_1.GitUri.fromFileStatus(f, repoPath) : undefined);
        super(uris, item || {
...
class OpenCommitFileRevisionsCommandQuickPickItem extends common_1.OpenFilesCommandQuickPickItem {
    constructor(commit, item) {
        const uris = system_1.Arrays.filterMap(commit.fileStatuses, f => f.status !== 'D' ? gitService_1.GitService.toGitContentUri(commit.sha, f.fileName, commit.repoPath, f.originalFileName) : undefined);
        super(uris, item || {
